...
block-beta
    ...
    Q1["<div style='padding:15px; text-align:center;'><span style='color:#ff6b6b; font-weight:bold; font-size:22px;'>Malo™</span><br/><br/><span style='color:#f1f5f9;'>Baja cohesión</span><br/><b><span style='color:#ff6b6b; border-bottom:3px double #ff6b6b;'>Alto acoplamiento</span></b></div>"]:1

    Y_AXIS["<div style='writing-mode: vertical-rl; transform: rotate(180deg); color:#ff8a8a; font-weight:bold; font-size:16px; padding:10px;'>▲ Acoplamiento ▲</div>"]:1

    Q2["<div style='padding:15px; text-align:center;'><span style='color:#ffb74d; font-weight:bold; font-size:28px;'>¿?</span><br/><br/><span style='color:#f1f5f9;'>Alta cohesión</span><br/><span style='color:#f1f5f9;'>Alto acoplamiento</span></div>"]:1

    X_LINE["<div style='border-top: 3px solid #ff8a8a;'></div>"]:3

    Q3["<div style='padding:15px; text-align:center;'><br/><span style='color:#f1f5f9;'>Baja cohesión</span><br/><span style='color:#f1f5f9;'>Bajo acoplamiento</span><br/><br/><span style='color:#ffb74d; font-weight:bold; font-size:28px;'>¿?</span></div>"]:1

    CENTER["<div style='color:#ff8a8a; font-weight:bold; text-align:left; padding-left:5px;'>Cohesión ►</div>"]:1

    Q4["<div style='padding:15px; text-align:center;'><br/><span style='color:#f1f5f9;'>Alta cohesión</span><br/><span style='color:#f1f5f9;'>Bajo acoplamiento</span><br/><br/><span style='color:#69f0ae; font-weight:bold; font-size:22px; border-top:3px double #69f0ae; display:inline-block; padding-top:4px;'>Bueno™</span></div>"]:1

    style Q1 fill:#1e1e1e,stroke:#444444
    style Q2 fill:#1e1e1e,stroke:#444444
    style Q3 fill:#1e1e1e,stroke:#444444
    style Q4 fill:#1e1e1e,stroke:#444444
    style Y_AXIS fill:none,stroke:none
    style X_LINE fill:none,stroke:none
